...
- Spell out amounts over one hundred thousand eg three million, 12 billion. (The rule of figures over 10 still applies). Except with symbols eg £130,000. 
- Try to avoid numbers at the beginning of sentences, if this is not possible always write it in full.

### Currency
- Prices should be written with currency first then number, closed up eg £9.99, £10,000.  Do not include decimal point if whole number, eg £5.  Millions should be written as eg £1 million, £1.5 million.
